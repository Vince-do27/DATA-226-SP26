...
with DAG(
    ...
    # Table names
    train_input  = "USER_DB_BOA.RAW.FUEL_PRICES"
    train_view   = "USER_DB_BOA.ADHOC.FUEL_PRICE_TRAIN_VIEW"
    model_name   = "USER_DB_BOA.ANALYTICS.FUEL_PRICE_FORECAST_MODEL"
    forecast_tbl = "USER_DB_BOA.ADHOC.FUEL_PRICE_FORECAST"
    final_tbl    = "USER_DB_BOA.ANALYTICS.FUEL_PRICE_FINAL"
    metrics_tbl  = "USER_DB_BOA.ANALYTICS.FUEL_PRICE_MODEL_METRICS"
