-- ============================================================
-- FUEL PRICE ANALYTICS — UPDATED SNOWFLAKE SETUP FOR BOA
...
SHOW SCHEMAS IN DATABASE USER_DB_BOA;

SHOW TABLES IN SCHEMA USER_DB_BOA.RAW;
SHOW TABLES IN SCHEMA USER_DB_BOA.ADHOC;
SHOW TABLES IN SCHEMA USER_DB_BOA.ANALYTICS;
SHOW TABLES IN SCHEMA USER_DB_BOA.DBT;

SHOW WAREHOUSES LIKE 'BOA_WH';
